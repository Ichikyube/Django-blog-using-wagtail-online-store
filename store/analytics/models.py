...
class ObjectViewed(models.Model):
    user                = models.ForeignKey(User, blank=True, null=True) #User instance instance.id ip_address
    ip_address          = models.CharField(blank=True, null=True, max_length=220) #models.IPAddressField(_(""))
...
class UserSession(models.Model):
    user                = models.ForeignKey(User, blank=True, null=True) #User instance instance.id ip_address
    ip_address          = models.CharField(blank=True, null=True, max_length=220) #models.IPAddressField(_(""))
    session_key         = models.CharField(blank=True, null=True, max_length=100)
    timestamp           = models.DateTimeField(auto_now_add=True)
